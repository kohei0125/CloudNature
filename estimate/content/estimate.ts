...
export const LP_COPY = {
  ...
  hero: {
    ...
    description:
      "過去の開発実績データをもとに、ハイブリッドAIエージェントが最適なシステム構成を逆算。従来のSIerでは数週間を要する「要件定義・開発計画書」と「データに基づく見積もり」を最短1分で自動生成し、そのまま稟議書として活用可能です。",
    descriptionShort:
      "AIエージェントが最適なシステム構成を逆算し、見積もりから開発計画書まで最短1分で自動生成します。",
    cta: "無料で見積もりを始める",
    ctaMicro: "",
  },
  ...
  simulator: {
    ...
    basisNote:
      "過去の開発実績データと選択条件をもとに、初期検討用の概算レンジを自動算出しています。",
    ...
    cards: [
      {
        ...
        subtitle: "データドリブンな精度",
        description:
          "開発実績データを学習したAIが、業種・規模・要件に応じた精度の高い概算を算出。勘や経験則に頼らない、データに裏付けされた見積もりを最短1分でお届けします。",
      },
      {
        number: "02",
        icon: "cpu",
    ...
    steps: [
      {
        ...
        title: "AI見積もり",
        description:
          "簡単な質問に答えるだけで、AIが最短1分で概算見積もりを自動生成。費用感をすぐに把握できます。",
      },
      {
        number: "02",
        title: "詳細ヒアリング",
  ...
  estimateDetails: {
    ...
    items: [
      ...
      },
      {
        title: "概算と正式見積もりの違い",
        points: [
          "概算見積もり：AIが過去データから自動算出。方向性と予算感の把握に最適",
          "正式見積もり：エンジニアがヒアリング後に作成。要件定義を含む詳細な見積もり",
          "概算から正式見積もりへの移行は無料。営業電話も一切ありません",
        ],
      },
      {
        title: "費用が変動する主な要因",
        points: [
          "機能の数と複雑さ（認証・決済・外部API連携など）",
          "対応デバイス（Web・iOS・Android・レスポンシブ）",
          "既存システムとの連携の有無",
          "セキュリティ・可用性の要件レベル",
        ],
      },
      {
        title: "こんなプロジェクトに向いています",
        points: [
          "業務効率化のためのWebアプリ・社内ツール",
          "AIチャットボット・社内ナレッジ検索システム",
          "既存システムのリプレイス・モダナイゼーション",
          "n8n・Dify等を活用した業務自動化の仕組みづくり",
        ],
      },
    ],
  },
  ...
  faq: {
    ...
    items: [
      {
        q: `${PRODUCT_NAME}の精度はどの程度ですか？`,
        a: `本サービス「${PRODUCT_NAME}」の見積もりは概算です。プロジェクトの方向性や予算感を素早く把握するためにご活用ください。詳細な見積もりは無料相談にて、ヒアリングのうえ作成いたします。`,
      },
      {
        q: "費用は本当にかかりませんか？",
        a: `${PRODUCT_NAME}での見積もり生成は完全無料です。クレジットカードの登録も不要で、営業電話も一切ありません。詳細見積もりや開発のご相談も、初回は無料で承っています。`,
      },
      {
