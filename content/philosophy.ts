...
export const FOUNDING_STORY = {
  ...
  paragraphs: [
    "まだやれることがたくさんある",
    "東京・大阪と様々なシステムの開発に携わる中で、テクノロジーが多くの人に影響を与える瞬間を見てきました。新潟に戻り、地元の経営者たちと話すたびに確信したのは、地方にはまだまだ可能性があるということです。",
    "AIやシステムの力は、まだ全ての企業に届いているわけではありません。必要としている会社と、それを届けられる会社の数が、まだ釣り合っていない。",
    "もっとできることがあるはず。AIという「産業革命以来の大変革」の波を、届けたい。その想いを胸に、CloudNatureを立ち上げました。",
  ]
};
...
export const MISSION_DEEP_DIVE = {
  ...
  description: "AIは今、日進月歩どころか「秒進分歩」で進化しています。新潟の中小企業が直面する最大の課題「人手不足」に対して、この技術をどこよりも深く使いこなし、最前線の解決策を届ける。それがCloudNatureの使命です。",
  points: [
...
export const DEV_APPROACH: DevApproachStep[] = [
  ...
  { step: 4, title: "一緒に作り上げる", description: "定期的な進捗共有とフィードバック。御社と一緒にシステムを磨き上げていきます。" },
