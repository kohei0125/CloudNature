...
export const HERO_COPY = {
  ...
  // システム開発 → AIエージェント開発 → 進め方 の順で語る（トップの見出し軸と揃える）。
  // 各段落の語句数（6）と総文字数は現行から ±3 以内に保つこと。モバイルで各段落2行に
  // 収まるようフォントサイズを追い込んであるため、長さを変えると折り返しが崩れる。
  paragraphs: [
    ["新潟の中小企業に、", "現場に合わせた", "システム開発を。", "受発注・在庫・勤怠を、", "業務の流れのまま", "仕組みに。"],
    ["さらに、判断を伴う", "タスクは", "AIエージェントへ。", "調査から実行までを、", "人の管理下で", "自律的に。"],
    ["いまの環境を活かし、", "必要なところから", "小さく始めて、", "使われる状態まで", "伴走します。"],
  ],
  heroImageAlt: "新潟の中小企業向けシステム開発・AIエージェント開発会社 クラウドネイチャー"
};
