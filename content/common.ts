...
export const PAGE_META = {
  ...
  services: {
    ...
    description: "AIエージェント開発、業務システム開発、AI導入・伴走支援。新潟の中小企業の業務効率化・人手不足解消を、スモールスタートで実現します。"
  },
  cases: {
  ...
  servicesSystemDev: {
    ...
    description: "受発注管理・在庫管理・勤怠管理など、御社の業務に合わせたオーダーメイド開発。既存システムを活かしたAPI連携で、段階的な業務効率化を実現します。"
  }
};
