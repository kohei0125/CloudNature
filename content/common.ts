...
export const PAGE_META = {
  // トップは会社全体の傘。「新潟 システム開発」を先頭に置き、「AIエージェント開発」を差別化語として続ける。
  // 「新潟 AI開発」の Owner は /usecases/niigata-ai-development-company-guide（本体で最良の順位）に委譲した。
  // 判断の経緯は docs/adr/0002-lead-with-system-development-on-top-page.md を参照。
  home: {
    title: "新潟のシステム開発・AIエージェント開発会社｜クラウドネイチャー",
    description:
      "新潟市を拠点に、業務システム開発とAIエージェント開発を手がける会社です。受発注・在庫・勤怠のオーダーメイド構築から、既存システムとの連携、判断を伴う業務の自動化まで。小さく始めて、使われる状態になるまで伴走します。"
  },
  services: {
  ...
  cases: {
    title: "AI導入事例｜見積もり作成の工数を90%以上削減など実際の成果 | クラウドネイチャー",
    description: "見積もりAIで作成工数を1件あたり約1時間から90%以上削減、コンテンツ制作の工数削減など、新潟の企業で実際に成果が出たAI導入事例を、課題・解決策・数字つきでご紹介します。"
  },
  contact: {
