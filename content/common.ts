...
export const PAGE_META = {
  home: {
    title: "新潟でAI導入から運用まで伴走する開発パートナー | 株式会社クラウドネイチャー",
    description:
      "新潟の中小企業向けAI導入・業務自動化の伴走型パートナー。「当たり前」になっている業務からAI活用し、まず1業務からスモールスタートで成果を実感。DX・AIエージェント開発・システム開発・経営者向けAIスクールも提供。無料診断実施中。"
  },
  services: {
    title: "新潟のAI導入支援・AIエージェント開発・システム開発 | 株式会社クラウドネイチャー",
  ...
  servicesSystemDev: {
    title: "新潟の業務システム開発・既存システム連携 | 株式会社クラウドネイチャー",
