...
export const REPRESENTATIVE_MESSAGE = {
  ...
  paragraphs: [
    "「テクノロジーの恩恵を、すべての企業へ。」",
    "新潟のIT企業からキャリアをスタートし、東京・大阪と、数十万人が毎日使うサービスの開発と大手企業のシステム構築に携わってきました。新潟に戻り、経営者たちと話すたびに確信したのは、地方にはまだまだ可能性があるということです。",
    "AIやシステムの力は、まだ全ての企業に届いているわけではありません。もっとできることがあるはず。その想いを胸に、CloudNatureを立ち上げました。",
  ]
};
