...
export const REPRESENTATIVE_MESSAGE = {
  ...
  paragraphs: [
    "「テクノロジーの恩恵を、すべての企業へ。」",
    "新潟のIT企業からキャリアをスタートし、東京・大阪と、数十万人が毎日使うサービスの開発と大手企業のシステム構築に携わってきました。新潟に戻り、話を聞くたびに確信したのは、地方にはまだまだ可能性があるということです。",
    "AIやシステムの力は、まだ全ての企業に届いているわけではありません。もっとできることがあるはず。その想いを胸に、クラウドネイチャーを立ち上げました。",
  ]
};
