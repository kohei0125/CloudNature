...
<p>2026年度、これまでの「IT導入補助金」が<strong>「デジタル化・AI導入補助金」</strong>に名称変更されました。名前が変わっただけではありません。国の令和7年度補正予算では中小企業のデジタル化・AI支援に<strong>3,400億円</strong>が計上されています。</p>
...
<p>まずは国の制度を見ていきます。それぞれ対象や金額が異なるため、自社の目的に合ったものを選ぶことが重要です。</p>
...
<thead><tr><th>項目</th><th>内容</th></tr></thead>
<tbody>
<tr><td>補助額</td><td>最大1,250万円（賃上げ加点で最大4,000万円）</td></tr>
<tr><td>補助率</td><td>1/2〜2/3</td></tr>
...
<thead><tr><th>項目</th><th>内容</th></tr></thead>
<tbody>
<tr><td>カタログ型</td><td>登録済み製品を選ぶだけで申請可能（AI搭載ロボット等）</td></tr>
<tr><td>一般型</td><td>オーダーメイドの省力化投資を支援</td></tr>
</tbody>
</table>
...
<tr><td>ものづくり補助金</td><td>1,250万円〜</td><td>独自開発に最適</td><td>中</td></tr>
<tr><td>新事業進出補助金</td><td>9,000万円</td><td>新事業に最適</td><td>高</td></tr>
<tr><td>省力化投資補助金</td><td>1,500万円〜</td><td>現場省人化に最適</td><td>中</td></tr>
<tr><td>持続化補助金</td><td>200万円</td><td>小さく始めるに最適</td><td>低</td></tr>
</tbody>
</table>
...
<p><strong>① 交付決定前に契約・発注してしまう</strong></p>
<p>最も多い失敗です。補助金は「交付決定後」に発注した費用のみが対象です。先に契約すると全額自己負担になります。</p>

<p><strong>② 登録されていないツールを選んでしまう</strong></p>
<p>デジタル化・AI導入補助金は、事前登録されたITツールのみが対象。導入したいツールが登録リストにあるか、必ず事前に確認してください。</p>

<p><strong>③ 過去利用の減点ルールを知らない</strong></p>
<p>IT導入補助金を2022〜2025年に利用した事業者は、2026年度の審査で減点されます。知らずに申請して不採択になるケースがあります。</p>

<p><strong>④ GビズIDプライムの取得が間に合わない</strong></p>
<p>申請にはGビズIDプライムが必須です。取得に2〜3週間かかるため、補助金の検討を始めた時点ですぐに申請してください。</p>
