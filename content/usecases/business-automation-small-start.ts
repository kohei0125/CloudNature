...
<p>もう少し大きな例では、私たちが自社で開発した<strong><a href="https://ai.cloudnature.jp/" target="_blank" rel="noopener noreferrer">AI見積もりシステム</a></strong>があります。システム開発の見積もりは、従来ヒアリングから算出まで数日かかっていました。これをAIチャットによる要件整理＋自動算出に置き換えた結果、<strong>見積もり作成時間が数日→約1分に短縮（工数95%削減）</strong>。この効果は社内だけでなく、お客様の「見積もりを待つ時間」も劇的に減らしました。</p>
<figure>
