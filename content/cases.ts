...
export const CASE_STUDY_DETAILS: CaseStudyDetail[] = [
  ...
  },
  {
    ...
    challenge: "社員研修の進捗管理をExcelで行い、受講状況の把握に毎月丸1日かかっていた。教材の更新も属人化しており、内容の陳腐化や研修品質のばらつきが常態化していた。",
    solution: "AIが受講者の理解度テストや学習履歴を分析し、一人ひとりに最適な学習コースを自動提案するLMSを構築。進捗ダッシュボードとレポート自動生成により、管理業務を大幅に効率化。",
    results: [
      "研修管理工数を90%削減",
      "研修完了率が45%→90%に向上",
      "受講者満足度が4.1→4.7に改善",
    ...
    quote: {
      text: "受講者ごとに最適なコースをAIが提案してくれるので、脱落者が激減しました。管理の手間もほぼゼロになり、研修の質向上に集中できています。",
      author: "人事部 部長",
      role: "研修サービス企業"
    },
