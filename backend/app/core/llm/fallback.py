...
_INDUSTRY_ESTIMATE_FEATURES: dict[str, list[dict]] = {
    "manufacturing": [
        {"name": "受発注管理", "detail": "受注・発注の一元管理と入力画面", "standard_price": 800000, "hybrid_price": 480000},
        {"name": "在庫管理", "detail": "在庫数のリアルタイム把握と入出庫管理", "standard_price": 700000, "hybrid_price": 420000},
        {"name": "生産スケジュール管理", "detail": "生産計画の作成・進捗管理", "standard_price": 600000, "hybrid_price": 360000},
        {"name": "原価計算", "detail": "製品ごとの原価計算とコスト分析", "standard_price": 500000, "hybrid_price": 300000},
        {"name": "月次レポート", "detail": "月次の売上・在庫レポート自動生成", "standard_price": 400000, "hybrid_price": 240000},
    ],
    "retail": [
        {"name": "商品管理", "detail": "商品マスタの登録・編集・一覧", "standard_price": 600000, "hybrid_price": 360000},
        {"name": "在庫管理・自動発注", "detail": "在庫数管理と発注点アラート", "standard_price": 700000, "hybrid_price": 420000},
        {"name": "売上分析", "detail": "売上データの集計とグラフ表示", "standard_price": 600000, "hybrid_price": 360000},
        {"name": "顧客管理", "detail": "顧客情報と購買履歴の管理", "standard_price": 500000, "hybrid_price": 300000},
        {"name": "帳票出力", "detail": "請求書・納品書のPDF出力", "standard_price": 400000, "hybrid_price": 240000},
    ],
    "construction": [
        {"name": "工事案件管理", "detail": "案件情報の一元管理と進捗追跡", "standard_price": 800000, "hybrid_price": 480000},
        {"name": "見積・請求管理", "detail": "見積書・請求書の作成と管理", "standard_price": 600000, "hybrid_price": 360000},
        {"name": "工程管理", "detail": "工程スケジュールの作成と共有", "standard_price": 600000, "hybrid_price": 360000},
        {"name": "原価管理", "detail": "工事ごとの原価・予実管理", "standard_price": 700000, "hybrid_price": 420000},
        {"name": "現場写真・日報", "detail": "現場写真のアップロードと日報管理", "standard_price": 400000, "hybrid_price": 240000},
    ],
    "food_service": [
        {"name": "予約管理", "detail": "予約カレンダーと空席管理", "standard_price": 600000, "hybrid_price": 360000},
        {"name": "メニュー管理", "detail": "メニューの編集・公開管理", "standard_price": 400000, "hybrid_price": 240000},
        {"name": "売上分析", "detail": "日次・月次の売上集計と分析", "standard_price": 500000, "hybrid_price": 300000},
        {"name": "シフト管理", "detail": "スタッフのシフト作成と共有", "standard_price": 400000, "hybrid_price": 240000},
        {"name": "顧客管理", "detail": "顧客情報と来店履歴の管理", "standard_price": 500000, "hybrid_price": 300000},
    ],
    "healthcare": [
        {"name": "患者情報管理", "detail": "患者・利用者の基本情報管理", "standard_price": 800000, "hybrid_price": 480000},
        {"name": "予約管理", "detail": "予約スケジュールの管理と通知", "standard_price": 600000, "hybrid_price": 360000},
        {"name": "請求管理", "detail": "請求・レセプトの作成と管理", "standard_price": 700000, "hybrid_price": 420000},
        {"name": "ケア記録", "detail": "服薬・ケア内容の記録と閲覧", "standard_price": 500000, "hybrid_price": 300000},
        {"name": "シフト管理", "detail": "スタッフのシフト作成と管理", "standard_price": 400000, "hybrid_price": 240000},
    ],
    "it_service": [
        {"name": "プロジェクト管理", "detail": "プロジェクトの進捗・タスク管理", "standard_price": 800000, "hybrid_price": 480000},
        {"name": "工数管理", "detail": "メンバーの工数入力とレポート", "standard_price": 600000, "hybrid_price": 360000},
        {"name": "顧客・案件管理", "detail": "顧客情報と案件の一元管理", "standard_price": 600000, "hybrid_price": 360000},
        {"name": "請求管理", "detail": "案件ごとの請求書作成と管理", "standard_price": 500000, "hybrid_price": 300000},
        {"name": "ナレッジベース", "detail": "社内ナレッジの蓄積・検索", "standard_price": 400000, "hybrid_price": 240000},
    ],
    "logistics": [
        {"name": "配車管理", "detail": "配車計画とルート最適化", "standard_price": 800000, "hybrid_price": 480000},
        {"name": "荷物追跡", "detail": "荷物のステータス管理と追跡", "standard_price": 700000, "hybrid_price": 420000},
        {"name": "倉庫在庫管理", "detail": "倉庫内の在庫数と入出庫管理", "standard_price": 600000, "hybrid_price": 360000},
        {"name": "ドライバー勤怠", "detail": "ドライバーの出退勤・稼働管理", "standard_price": 500000, "hybrid_price": 300000},
        {"name": "配送レポート", "detail": "配送実績の集計とダッシュボード", "standard_price": 400000, "hybrid_price": 240000},
    ],
}

_DEFAULT_ESTIMATE_FEATURES: list[dict] = [
    {"name": "データ管理画面", "detail": "データの登録・編集・削除・一覧表示", "standard_price": 800000, "hybrid_price": 480000},
    {"name": "ダッシュボード", "detail": "主要KPIの可視化とグラフ表示", "standard_price": 600000, "hybrid_price": 360000},
    {"name": "帳票出力", "detail": "PDF・Excel形式でのレポート出力", "standard_price": 400000, "hybrid_price": 240000},
    {"name": "検索・フィルタ", "detail": "データの高度な検索とフィルタリング", "standard_price": 300000, "hybrid_price": 180000},
    {"name": "通知機能", "detail": "メール・プッシュ通知による自動通知", "standard_price": 400000, "hybrid_price": 240000},
]
