...
import { SERVICE_DETAILS, AI_SUPPORT_FAQ, SERVICES_BOTTOM_CTA, SERVICE_PAGE_MAP } from "@/content/services";
...
const relatedLinks = getRelatedLinksForService("ai-support");
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify([breadcrumb, serviceJsonLd({ ...service, path: SERVICE_PAGE_MAP[service.id].path }), faqPageJsonLd(AI_SUPPORT_FAQ)]) }}
      />
      <PageHero
