  ...
  return (
    <div className="w-full bg-[#F0EEE9]">
      ...
      <section className="relative min-h-screen flex items-center pt-24 pb-12 overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full overflow-hidden z-0 bg-[#F0EEE9]">
          {/* Aurora Blobs */}
          <div className="absolute top-[-10%] left-[-10%] w-[700px] h-[700px] bg-[#C8E8FF] rounded-full mix-blend-multiply filter blur-[120px] opacity-40 animate-blob"></div>
          <div className="absolute top-[-10%] right-[-10%] w-[600px] h-[600px] bg-[#8A9668] rounded-full mix-blend-multiply filter blur-[120px] opacity-30 animate-blob animation-delay-2000"></div>
          <div className="absolute bottom-[-20%] left-[20%] w-[600px] h-[600px] bg-[#DD9348] rounded-full mix-blend-multiply filter blur-[120px] opacity-30 animate-blob animation-delay-4000"></div>
