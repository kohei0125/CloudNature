...
const HeroCardAi = () => {
  return (
    <div className="h-[260px] md:h-[240px] lg:h-full rounded-[24px] md:rounded-[40px] bg-[#F4F2F0] p-5 flex flex-col justify-between relative overflow-hidden group hover:shadow-lg transition-all duration-300 w-full border border-white/50">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#F4F2F0]/80 via-transparent to-[#F4F2F0]/40"></div>
      </div>
      ...
      <div className="relative h-[80px] w-full flex items-end justify-start px-2 mt-4 z-10">
        <div className="w-12 h-12 bg-white/80 backdrop-blur-md rounded-2xl flex items-center justify-center shadow-sm border border-white/60">
          <Bot className="w-6 h-6 text-[#DD9348]" />
        </div>
      </div>

      <div className="mt-2 relative z-10">
        <h4 className="font-bold text-[#19231B] leading-tight text-sm whitespace-pre-line mb-2">
