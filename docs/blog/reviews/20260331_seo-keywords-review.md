...
- 対象ドキュメント: `docs/blog/research/20260331_seo-keywords.md`
- 対象サイト:
  - `cloudnature.jp`
  - `ai.cloudnature.jp`
...
したがって、`docs/blog/research/20260331_seo-keywords.md` は実行計画としてではなく、キーワード候補集として扱うのが適切です。
...
1. `docs/blog/research/20260331_seo-keywords.md` を実行計画としては使わず、候補集に格下げする
...
→ [`docs/TODO.md`](TODO.md) に統合（プロジェクト全体の TODO として管理）
